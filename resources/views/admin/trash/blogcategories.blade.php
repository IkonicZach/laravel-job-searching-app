@section('title', 'Blog Categories Trash Can | Skilltrack')
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('blogcategory.restore', $cat->id) }}" method="POST">
                                        @csrf
                    ...
                    <div class="modal fade" id="delete{{ $cat->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('blogcategory.delete', $cat->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Close</button>
