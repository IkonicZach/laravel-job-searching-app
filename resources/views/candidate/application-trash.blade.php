        ...
        @if (!empty($trashes))
            @if (count($trashes) > 0)
                @foreach ($trashes as $trash)
                    <!-- Application Restore Confirm Modal starts here -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('application.restore', $trash->id) }}" method="POST">
                                        @csrf
                    ...
                    <!-- Application Restore Confirm Modal ends here -->

                    <!-- Application Delete Confirm Modal starts here -->
                    <div class="modal fade" id="delete{{ $trash->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('application.delete', $trash->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Close</button>
                    ...
                    <!-- Application Delete Confirm Modal ends here -->
                ...
                @endforeach
            @else
                <h4 class="text-muted">No application available</h4>
            @endif
        @endif
    </div>
@endsection
