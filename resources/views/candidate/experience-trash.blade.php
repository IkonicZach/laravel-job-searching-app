@section('title', 'Experiences Trash Can | Skilltrack')
@extends('layout.trash-can')
@section('table')
    <h3>Experiences</h3>
    <div class="table-head row g-0">
        <div class="th col-2"><b>#</b></div>
        <div class="th col-3"><b>Job Title</b></div>
        ...
        @if (!empty($trashes))
            @if (count($trashes) > 0)
                @foreach ($trashes as $trash)
                    <!-- Experience Restore Confirm Modal starts here -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Are you sure you want to restore this experience?
                                </div>
                                <div class="modal-footer">
                                    <form action="{{ route('experience.restore', $trash->id) }}" method="POST">
                                        @csrf
                    ...
                    <!-- Experience Restore Confirm Modal ends here -->

                    <!-- Experience Delete Confirm Modal starts here -->
                    <div class="modal fade" id="delete{{ $trash->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('experience.delete', $trash->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Close</button>
                    ...
                    <!-- Experience Delete Confirm Modal ends here -->
                ...
                @endforeach
            @else
                <h4 class="text-muted">No experience available</h4>
            @endif
        @endif
    </div>
@endsection
