@section('title', 'Resumes Trash Can')
        ...
        @if (!empty($trashes))
            @if (count($trashes) > 0)
                @foreach ($trashes as $trash)
                    <!-- Resume Restore Confirm Modal starts here -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Are you sure you want to restore this resume?
                                </div>
                                <div class="modal-footer">
                                    <form action="{{ route('resume.restore', $trash->id) }}" method="POST">
                                        @csrf
                    ...
                    <!-- Resume Restore Confirm Modal ends here -->

                    <!-- Resume Delete Confirm Modal starts here -->
                    <div class="modal fade" id="delete{{ $trash->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('resume.delete', $trash->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Close</button>
                    ...
                    <!-- Resume Delete Confirm Modal ends here -->
                ...
                @endforeach
            @else
                <h4 class="text-muted">No resume available</h4>
            @endif
        @endif
    </div>
@endsection
