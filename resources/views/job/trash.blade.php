@section('title', 'Job Trash Can | Skilltrack')
        ...
        @if (!empty($trashes))
            @if (count($trashes) > 0)
                @foreach ($trashes as $trash)
                    <!-- Job Restore Confirm Modal starts here -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('job.restore', $trash->id) }}" method="POST">
                                        @csrf
                    ...
                    <!-- Job Restore Confirm Modal ends here -->
                    ...
                    <div class="modal fade" id="delete{{ $trash->id }}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ route('job.delete', $trash->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Close</button>
