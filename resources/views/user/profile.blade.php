                ...
                <div class="col-lg-8 col-md-7 col-12">
                    ...
                    @if (count($blogs) > 0)
                        ...
                        <div class="row g-4 mt-4">
                                            ...
                                            <div class="p-4">
                                                <ul class="list-unstyled text-muted small mb-2">
                                                    <li class="d-inline-flex align-items-center me-2">
                                                        <i
                                                            class="fa-regular fa-calendar fea icon-ex-sm me-1 text-dark"></i>
                            ...
                            {{-- @if (count($allBlogs) > 4) --}}
                            <div class="row justify-content-center mt-3">
                                <a class="btn btn-sm btn-primary col-2" data-bs-toggle="modal" data-bs-target="#blogAll">
                                    View All
                                </a>
                            </div>
                            {{-- @endif --}}
                    ...
                    @endif
                    {{-- Posted Blogs Section Ends Here  --}}
